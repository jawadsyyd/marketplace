...
<body>
    <div class="container-fluid p-3">
        <div class="row  align-items-center">
            <div class="col-8 col-md-10">
                <h2 class="display-5 fw-semibold" style="color: #1D3357;">Categories</h2>
            </div>
            <div class="col-4 col-md-2 position-relative">
                <button type="button" class="btn position-absolute end-0 me-3" id="btnAdd">
        ...
        <table class="table table-bordered table-primary table-striped-columns table-hover   mt-3 text-center" id="doctorInfo">
            ...
            if ($result->rowCount() > 0) {
                foreach ($result as $category) {
                    ...
                    echo "<td><button class='btn update-btn btn-warning btn-sm' name='update'><a href='http://localhost/server/marketplace/pages/updateCategory.php?updateid=" . $category['Category_Id'] . "'' class='text-dark' style='text-decoration: none;'>
  ...
  <path fill-rule='evenodd' d='M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z'/>
                    ...
                    echo " <button class='btn delete-btn btn-sm' name='delete' id='btnDelete'><a href='http://localhost/server/marketplace/pages/deleteCategory.php?deleteid=" . $category['Category_Id'] . "' class='text-dark' style='text-decoration: none;'>
