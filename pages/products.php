    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-4 col-md-2">
                <button name="add" type="submit" class="btn btn-primary float-end"><a href="http://localhost/server/marketplace/pages/insertProduct.php" class="text-light" style="text-decoration: none;"><i class="bi bi-plus-lg"></i>
                        Add</a></button>
            </div>
        </div>
