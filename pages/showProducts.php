...
<body>
        ...
        <nav class="navbar  position-absolute end-0">
          <div class="container-fluid">
            <form class="d-flex" role="search" method="post">
              <select class="form-select  text-center me-2 d-sm-flex d-none" id="floatingSelect" aria-label="Floating label select example" name="sortBy" onchange="Change()">
  ...
  <div class="container">
    <div class="row">
      ...
      } //END ELSE OF SELECT PRODUCTS WITH AND WITHOUT PROMOTIONS
